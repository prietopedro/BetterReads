...
function Landing() {
  ...
  return (
    <>
      <Navbar />
      <>
        <Flex align="center" justify="space-evenly" m="3rem" direction={{base: "column", lg: "row"}}>
        ...
        <Flex mt="8rem" justify="center" align="center" direction={{base: "column", lg: "row"} }>
